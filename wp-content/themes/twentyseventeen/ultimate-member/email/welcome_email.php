...
<div style="padding: 20px;">If you have any problems, please contact us at <a style="color: #3ba1da; text-decoration: none;" href="mailto:{admin_email}">{nestorperezharo9@gmail.com}</a></div>
</div>
<div style="color: #999; padding: 20px 30px;">
<div>Thank you!</div>
<div>The<a href="http://localhost/wp/"> {site_name} </a>Team</div>
</div>
</div>